    ...
    <div className="mx-auto max-w-3xl px-6 py-16">
      ...
      <section className="mb-16">
        <p className="text-gray-700 leading-relaxed dark:text-gray-300">
          I build React/Next.js products end to end — from backend API
          integration through CI/CD, test automation, and security review. Most
          of my recent work has been on data-intensive platforms in biotech: 3D
          molecular visualization, scientific charting, and the bundle-size and
          delivery-pipeline discipline that keeps those products fast to load
          and safe to ship. I also use Claude Code and Codex to automate parts
          of testing, review, and refactoring in day-to-day development.
        </p>
      </section>
      ...
      <section className="mb-16">
        ...
        <div className="border-l-2 border-gray-200 pl-5 dark:border-gray-800">
          <h3 className="font-semibold text-gray-900 dark:text-gray-100">
            Hankuk University of Foreign Studies (Global)
          </h3>
          <p className="text-sm text-gray-500 dark:text-gray-500">
            Computer &amp; Electronic Systems Engineering &middot; 2018 – 2023
          </p>
        </div>
      </section>
      ...
      <section className="text-center py-12 border-t border-gray-200 dark:border-gray-800">
        ...
        <p className="text-gray-600 mb-6 dark:text-gray-400">
          Available for contract and B2B engagements from October 2026.
        </p>
