...
export default async function WorkPage({
  ...
  const chipOff =
    'border-gray-300 text-gray-600 hover:border-[#00224D] hover:text-[#00224D] dark:border-gray-700 dark:text-gray-400 dark:hover:border-[#38bdf8] dark:hover:text-[#38bdf8]'
